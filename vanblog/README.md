...
<p align="center">
	<strong>BianBlog是一款简洁、实用、优雅的个人博客系统，支持全自动按需申请HTTPS证书、黑暗模式、移动端自适应和评论功能。它内置了流量统计和图床，并集成了评论系统。此外，BianBlog还具有无限的可扩展性，提供完备的后台管理面板，支持黑暗模式、移动端、一键上传剪贴板图片到图床，并带有强大的编辑器。</strong>
</p>
<p align="center">
  <img src="https://img.shields.io/github/v/release/mereithhh/bian-blog?display_name=tag" />
  <img src="https://img.shields.io/docker/pulls/mereith/bian-blog" />
  <img src="https://img.shields.io/github/stars/mereithhh/bian-blog" />
  <img src="https://img.shields.io/bitbucket/issues/mereithhh/bian-blog" />
  <img src="https://github.com/mereithhh/bian-blog/workflows/release/badge.svg" />
  <img src="https://img.shields.io/badge/license-GPL%20v3-yellow.svg" />
</p>
<p align="center">
	<strong>项目主页: </strong>  <a target="_blank" href='https://bianblog.mereith.com'>bianblog.mereith.com</a>
</p>
<p align="center">
...
```bash
curl -L https://bianblog.mereith.com/bianblog.sh -o bianblog.sh && chmod +x bianblog.sh && ./bianblog.sh
```
...
具体请移步项目文档：[快速上手](https://bianblog.mereith.com/guide/get-started.html)

## 反代

请参考： [反代](https://bianblog.mereith.com/reference/reverse-proxy.html)

## 常见问题

> [备份与迁移](https://bianblog.mereith.com/guide/backup.html)
>
> [作者 logo 无法加载](https://bianblog.mereith.com/faq/usage.html#图片-作者-logo-加载不出来)
>
> [http error](https://bianblog.mereith.com/faq/deploy.html#部署后-http-error)
>
> [docker 镜像拉取慢](https://bianblog.mereith.com/faq/deploy.html#docker-镜像拉取慢)
>
> [如何外部访问数据库](https://bianblog.mereith.com/faq/deploy.html#如何在外部访问数据库)
>
> [如何回滚](https://bianblog.mereith.com/faq/update.html#如何回滚)
>
> [如何升级](https://bianblog.mereith.com/guide/update.html)
>
> [更新后后台报错||一直加载中](https://bianblog.mereith.com/faq/update.html#升级后后台报错或持续加载)
>
> [开启了 https 重定向后关不掉](https://bianblog.mereith.com/faq/usage.html#开启了-https-重定向后关不掉)
>
> [更多常见问题](https://bianblog.mereith.com/faq/)
...
- [BianBlog 交流群](https://jq.qq.com/?_wv=1027&k=5NRyK2Sw)

## 说明与文档

请移步项目主页： [https://bianblog.mereith.com](https://bianblog.mereith.com)
...
- [开发指南](https://bianblog.mereith.com/contribution.html)

## 谁在使用

现在可能用的人有一些了吧 - -

如果您想把自己加进来，请提一个 [issue](https://github.com/Mereithhh/bian-blog/issues/new/choose)，我会尽快添加的。
...
请提 [issue](https://github.com/Mereithhh/bian-blog/issues/new/choose) ，如无特殊情况会在一天内解决。
...
[![Star History Chart](https://api.star-history.com/svg?repos=mereithhh/bian-blog&type=Date)](https://star-history.com/#mereithhh/bian-blog&Date)
