import { getStaticSetting, updateStaticSetting } from '@/services/bian-blog/api';
        ...
        {storageType == 'picgo' && (
          <>
            <ProFormTextArea
              ...
              label={
                <a
                  href="https://bianblog.mereith.com/feature/basic/pic.html#%E5%A4%96%E7%BD%AE%E5%9B%BE%E5%BA%8A"
                  target={'_blank'}
                  rel="norefferrer"
                >
                  picgo 配置
