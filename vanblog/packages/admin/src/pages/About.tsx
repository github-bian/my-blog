      ...
      <Spin spinning={version == '获取中'}>
        <ProCard>
          ...
          >
            ...
            <Space>
              <a target={'_blank'} rel="noreferrer" href="https://github.com/Mereithhh/bian-blog">
                Github
              </a>
              <a target={'_blank'} rel="noreferrer" href="https://bianblog.mereith.com">
                项目文档
              </a>
              <a
                target={'_blank'}
                rel="noreferrer"
                href="https://bianblog.mereith.com/changelog.html"
              >
                更新日志
              </a>
            ...
            <Space style={{ marginTop: 8 }}>
              <a
                target={'_blank'}
                rel="noreferrer"
                href="https://github.com/Mereithhh/bian-blog/issues/new/choose"
              >
                提交BUG
              </a>
              <a
              ...
              <a
                target={'_blank'}
                rel="noreferrer"
                href="https://github.com/Mereithhh/bian-blog#%E6%89%93%E8%B5%8F"
              >
                打赏
              </a>
