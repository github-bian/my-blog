...
import {
  ...
  updateArticle,
  updateDraft,
} from '@/services/bian-blog/api';
import { getPathname } from '@/services/bian-blog/getPathname';
import { parseMarkdownFile, parseObjToMarkdown } from '@/services/bian-blog/parseMarkdownFile';
import { useCacheState } from '@/services/bian-blog/useCacheState';
  ...
  const fetchData = useCallback(
    async (noMessage) => {
      ...
      if (type == 'about') {
        ...
        document.title = `关于 - BianBlog 编辑器`;
        setCurrObj(data);
      }
      if (type == 'article' && id) {
        ...
        document.title = `${data?.title || ''} - BianBlog 编辑器`;
        setCurrObj(data);
      }
      if (type == 'draft' && id) {
        ...
        <div style={{ marginTop: 8 }}>
          ...
          <p>
            ...
            <a
              target={'_blank'}
              rel="noreferrer"
              href="https://bianblog.mereith.com/feature/basic/editor.html#%E4%B8%80%E9%94%AE%E6%8F%92%E5%85%A5-more-%E6%A0%87%E8%AE%B0"
            >
              相关文档
            </a>
          </p>
    ...
    <Menu
      items={[
        ...
        },
        {
          ...
          label: '帮助文档',
          onClick: () => {
            window.open('https://bianblog.mereith.com/feature/basic/editor.html', '_blank');
          },
        },
      ]}
    ></Menu>
