          ...
          <div>
            <p>
              ...
              <a
                target={'_blank'}
                rel="noreferrer"
                href="https://bianblog.mereith.com/guide/https.html"
              >
                相关文档
              </a>
            </p>
            <p>高级玩家可点击按钮查看 Caddy 运行日志或配置排查错误。</p>
            <p>access 日志可进入容器 /var/log/bianblog-access.log 查看</p>
          </div>
        }
        ...
        message={
          <div>
            ...
            <p>
              ...
              <a
                href="https://bianblog.mereith.com/faq/usage.html#开启了-https-重定向后关不掉"
                target="_blank"
              >
                开启了 https 重定向后关不掉
              </a>
