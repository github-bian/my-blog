import { createApiToken, getAllApiTokens, deleteApiToken } from '@/services/bian-blog/api';
            ...
            <Button
              onClick={() => {
                Modal.info({
                  ...
                  content: (
                    <div>
                      <p>创建的 Api Token 可以用来调用 BianBlog 的 API</p>
                      ...
                      <p>
                        <a
                          target="_blank"
                          rel="noreferrer"
                          href="https://bianblog.mereith.com/advanced/token.html"
                        >
                          相关文档
                        </a>
                      </p>
