...
export default function (props: {
  ...
  useEffect(() => {
    if (!current.hasInit && !localStorage.getItem("saidHello")) {
      ...
      console.log("项目主页：", "https://github.com/Mereithhh/bianblog");
      console.log("品牌：", "BianBlog");
    ...
    <>
      ...
      >
        ...
        {/* <ImageProvider> */}
          ...
          <div className=" mx-auto lg:px-6 md:py-5 py-3 px-3 md:px-4 text-gray-700 max-w-6xl">
