  ...
  return (
    <>
      ...
      >
        {/* 上面的导航栏 */}
        <div
          className=" flex  items-center w-full border-b border-gray-100 h-14 dark:border-nav-dark"
          style={{ height: 56 }}
        >
          ...
          <div className="flex justify-between h-full flex-grow nav-content">
            ...
            <div className="flex nav-action">
              <div
                ...
                title="搜索"
                className="flex group transition-all select-none cursor-pointer"
              >
        ...
        {Boolean(props.categories.length) && props.showSubMenu == "true" && (
          <div className="h-10 items-center hidden md:flex border-b border-gray-100 dark:border-nav-dark overflow-hidden">
            <div
              className="mx-5"
            ...
            <ul className="flex h-full items-center text-sm text-gray-600 dark:text-dark ">
              {props.categories.map((catelog) => {
                return (
                  <li
                    key={catelog}
                    className="flex items-center h-full md:px-2 hover:text-gray-900 dark:hover:text-dark-hover cursor-pointer transition-colors"
                  >
