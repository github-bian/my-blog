  ...
  return (
    <div className="post-card-wrapper">
      <div
        ...
        id="post-card"
        className="overflow-hidden post-card bg-white card-shadow py-5 px-2 sm:px-4 md:py-8 md:px-6 dark:bg-dark dark:card-shadow-dark"
      >
        ...
        {props.type == "overview" && (
          <div className="w-full flex justify-center mt-4 ">
            ...
            >
              <div className=" dark:bg-dark dark:hover:bg-dark-light dark:hover:text-dark-r dark:border-dark dark:text-dark hover:bg-gray-900 hover:text-white border border-gray-300 text-sm md:text-base text-gray-600 px-5 py-1.5 transition-all rounded-full">
                阅读全文
              </div>
            </Link>
          </div>
